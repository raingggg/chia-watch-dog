...
echo "line 1" >>${LOG_FILE_NAME}
echo "line 2" >>${LOG_FILE_NAME}
echo "line 3" >>${LOG_FILE_NAME}
echo "line 4" >>${LOG_FILE_NAME}
echo "line 5" >>${LOG_FILE_NAME}
echo "line 6" >>${LOG_FILE_NAME}
echo "line 7" >>${LOG_FILE_NAME}
echo "line 8" >>${LOG_FILE_NAME}
echo "line 9" >>${LOG_FILE_NAME}
echo "line 10" >>${LOG_FILE_NAME}
echo "line 11" >>${LOG_FILE_NAME}
echo "line 12" >>${LOG_FILE_NAME}
echo "line 13" >>${LOG_FILE_NAME}
echo "line 14" >>${LOG_FILE_NAME}
echo "line 15" >>${LOG_FILE_NAME}
echo "line 16" >>${LOG_FILE_NAME}
echo "line 17" >>${LOG_FILE_NAME}
echo "line 18" >>${LOG_FILE_NAME}
echo "line 19" >>${LOG_FILE_NAME}
echo "line 20" >>${LOG_FILE_NAME}
...
echo "2021-11-11T22:43:57.131 full_node chia.full_node.full_node: INFO     ⏲️  Finished signage point 63/64: 1n4dxa2d720755a72fe6507193d8d441732cb083a0128d9ye915125y9c01" >>${LOG_FILE_NAME}
echo "2021-11-11T22:44:16.207 full_node chia.full_node.full_node: INFO     ⏲️  Finished signage point 1/64: 1n4dxa2d720755a72fe6507193d8d441732cb083a0128d9ye915125y9c01" >>${LOG_FILE_NAME}
echo "2021-11-11T22:45:24.923 full_node chia.full_node.full_node: INFO     ⏲️  Finished signage point 9/64: 1n4dxa2d720755a72fe6507193d8d441732cb083a0128d9ye915125y9c01" >>${LOG_FILE_NAME}

echo "2021-11-11T02:42:44.183 full_node flora_proxy: chia.full_node.full_node: INFO     ⏲️  Finished signage point 40/64: CC: 943160d41fd910f81d1b32928e676873e0a007c74ec709fbfa92118a8e69ca05 RC: 6ddad5b3f0114ab2c667cd4f8d907d62204ecaf6031fe751044f1cd87b9e58e5" >>${LOG_FILE_NAME}
...
echo "2021-11-16T04:42:44.183 full_node flora_proxy: chia.full_node.full_node: INFO     ⏲️  Finished signage point 63/64: CC: 943160d41fd910f81d1b32928e676873e0a007c74ec709fbfa92118a8e69ca05 RC: 6ddad5b3f0114ab2c667cd4f8d907d62204ecaf6031fe751044f1cd87b9e58e5" >>${LOG_FILE_NAME}
